...
SSH keys forwarded:
3072 SHA256:ggx79kaOIbMnz6WK7UJnSFEDb6cXjoStHdZTmPGjSFs twang1@LDALmacJ1D4JGH8 (RSA)

GPG keys imported:
gpg: keybox '/mnt/gpg/pubring.kbx' created
gpg: /mnt/gpg/trustdb.gpg: trustdb created
gpg: key E2B3F76FD894AB56: public key "Example <example@example.com>" imported
...
pub   rsa2048 2020-01-27 [SC]
      C5072F3CF3E0DBD7132EC84BE2B3F76FD894AB56
...
GPG keys imported:
gpg: key E2B3F76FD894AB56: "Example <example@example.com>" not changed
gpg: Total number processed: 1
gpg:              unchanged: 1
